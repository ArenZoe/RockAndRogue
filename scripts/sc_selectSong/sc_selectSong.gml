...
/// @DnDVersion : 1
/// @DnDHash : 11D3A4C4
/// @DnDArgument : "code" "function selectSong(roundNumber,setlistIndex){$(13_10)	var bucketTable = [$(13_10)		[0,0,1],$(13_10)		[0,0,1],$(13_10)		[0,1,2],$(13_10)		[1,2,3],$(13_10)		[1,2,3],$(13_10)		[2,3,4],$(13_10)		[2,3,4],$(13_10)		[3,4,5],$(13_10)		[3,4,5],$(13_10)		[4,5,6],$(13_10)		[4,5,6],$(13_10)		[5,6,6],$(13_10)		[5,6,6],$(13_10)		[6,6,6],$(13_10)		[6,6,7],$(13_10)		[6,7,7],$(13_10)		[6,7,7],$(13_10)		[7,7,7],$(13_10)		[7,7,7],$(13_10)		[7,7,7],$(13_10)		[-1,-1,-1],$(13_10)	];$(13_10)	$(13_10)	var bucketNumber = bucketTable[clamp((roundNumber-1),0,array_length(bucketTable)),setlistIndex];$(13_10)	var bucketSongIndexes = [];$(13_10)	$(13_10)	for (var i = 0; i< array_length(global.pack.songs); i++){$(13_10)			if (global.pack.songs[i].bucket = bucketNumber or bucketNumber = -1){$(13_10)				if (!array_contains(global.seenSongs,i)){$(13_10)					array_push(bucketSongIndexes,i);$(13_10)				}$(13_10)			}$(13_10)	}$(13_10)	$(13_10)	$(13_10)	if (array_length(bucketSongIndexes) = 0){$(13_10)		global.seenSongs = [];$(13_10)		return selectSong(roundNumber, setlistIndex);$(13_10)	}$(13_10)	$(13_10)	var selectedSongIndex = bucketSongIndexes[irandom(array_length(bucketSongIndexes)-1)]$(13_10)	$(13_10)	array_push(global.seenSongs,selectedSongIndex);$(13_10)	return selectedSongIndex;$(13_10)}$(13_10)$(13_10)$(13_10)"
function selectSong(roundNumber,setlistIndex){
	...
	var bucketNumber = bucketTable[clamp((roundNumber-1),0,array_length(bucketTable)),setlistIndex];
	var bucketSongIndexes = [];
	
	for (var i = 0; i< array_length(global.pack.songs); i++){
			if (global.pack.songs[i].bucket = bucketNumber or bucketNumber = -1){
