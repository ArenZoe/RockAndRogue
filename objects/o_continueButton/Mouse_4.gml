...
if !file_exists(scorePath)
{
	...
	//TODO - show message about needing newest CH version and locating score file
	
    //load the scorestats.json file
	scorePath = get_open_filename("score file|scorestats.json","");
	if (scorePath =""){
		exit;
	}
