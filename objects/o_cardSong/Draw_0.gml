...
/// @DnDArgument : "fill" "1"
draw_rectangle(x + 0, y + 0, x + 574, y + 176, 0);
...
/// @DnDArgument : "y2_relative" "1"
/// @DnDArgument : "fill" "1"
draw_rectangle(x + 16, y + 16, x + 95, y + 95, 0);
...
/// @DnDArgument : "xscale" "76 / (sprite_get_width(songAlbum))"
/// @DnDArgument : "yscale" "76 / (sprite_get_height(songAlbum))"
/// @DnDArgument : "sprite" "songAlbum"
draw_sprite_ext(songAlbum, 0, x + 18, y + 18, 76 / (sprite_get_width(songAlbum)), 76 / (sprite_get_height(songAlbum)), 0, $FFFFFF & $ffffff, 1);
...
/// @DnDVersion : 1
/// @DnDHash : 2D9AA288
/// @DnDArgument : "code" "draw_text_ext(x+112,y+12,string_copy(global.pack.songs[songIndex].name,0,56),19,400)"
draw_text_ext(x+112,y+12,string_copy(global.pack.songs[songIndex].name,0,56),19,400)
...
/// @DnDVersion : 1
/// @DnDHash : 134D9D95
/// @DnDArgument : "code" "draw_text_ext(x+112,y+72,string_copy(global.pack.songs[songIndex].charter,0,28),18,400)"
draw_text_ext(x+112,y+72,string_copy(global.pack.songs[songIndex].charter,0,28),18,400)
...
draw_text(x + 112, y + 82,  + string(msToTimestamp(global.pack.songs[songIndex].length)));
...
/// @DnDVersion : 1
/// @DnDHash : 03F2D64A
/// @DnDArgument : "code" "draw_text_ext(x+186,y+84,string_copy(global.pack.songs[songIndex].genre,0,24),18,400)"
draw_text_ext(x+186,y+84,string_copy(global.pack.songs[songIndex].genre,0,24),18,400)
...
draw_text(x + 390, y + 70, string("+") + string(songMoney));
...
/// @DnDArgument : "y2" "104"
/// @DnDArgument : "y2_relative" "1"
draw_line(x + 16, y + 104, x + 560, y + 104);
...
draw_sprite_ext(asset_get_index(string_concat("instrument_",global.pack.songs[songIndex].instrument)), 0, x + 20, y + 112, .4, .4, 0, $FFFFFF & $ffffff, 1);

/// @DnDAction : YoYo Games.Common.If_Expression
/// @DnDVersion : 1
/// @DnDHash : 2F879C78
/// @DnDArgument : "expr" "(global.pack.songs[songIndex].intensity >= 0)"
