...
string("Notes Missed: ") + string(global.playData.players[0].notes_missed),
string("Total Notes: ") + string(global.playData.players[0].total_notes),
string("Best Streak: ") + string(global.playData.players[0].max_streak),
...
string("Star Power Phrases Missed: ") + string(global.playData.players[0].sp_phrases_missed),
...
/// @DnDVersion : 1
/// @DnDHash : 13E26A28
/// @DnDArgument : "cond" "i < (array_length(resultsTextArray))"
for(i = 0; i < (array_length(resultsTextArray)); i += 1) {	/// @DnDAction : YoYo Games.Drawing.Draw_Value
	/// @DnDVersion : 1
	/// @DnDHash : 47E237CC
	/// @DnDParent : 13E26A28
