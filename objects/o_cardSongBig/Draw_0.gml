...
/// @DnDVersion : 1
/// @DnDHash : 2D9AA288
/// @DnDArgument : "code" "draw_text_ext(x+186,y+23,string_copy(global.pack.songs[songIndex].name,0,38),30,664)"
draw_text_ext(x+186,y+23,string_copy(global.pack.songs[songIndex].name,0,38),30,664)
